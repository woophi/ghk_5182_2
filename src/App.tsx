...
const sduiLink =
  'alfabank://sdui_screen?screenName=InvestmentLongread&fromCurrent=true&endpoint=v1/invest-main-screen-view/investment-longread/52460%3flocation=AM%26campaignCode=GH';
const sduiLink2 =
  'alfabank://sdui_screen?screenName=InvestmentLongread&fromCurrent=true&endpoint=v1/invest-main-screen-view/investment-longread/52461%3flocation=AM%26campaignCode=GH';
...
export const App = () => {
  ...
  const submitWith = () => {
    window.gtag('event', '5182_buy1_var2');
    setLoading(true);
    window.location.replace(sduiLink);
  };
  const submitWithout = () => {
    window.gtag('event', '5182_buy2_var2');
